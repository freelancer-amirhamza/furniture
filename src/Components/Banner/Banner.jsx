          ...
          <div className='md:w-[40%] w-full 5/5 relative md:px-2'>
            <div className='md:absolute md:left-[20%] flex py-20 md:py-0 items-center h-full w-full '>
              <div className=' pr-2 pl-1 md:pl-0 md:w-[80%] w-full'>
                ...
                <p className='my-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita ducimus maxime velit impedit distinctio dicta. </p>
                <div className='w-[95%] md:w-full'>
                  <form className='flex border border-[#492705] '>
                    ...
                    <button type='submit' className='bg-[#492705] text-white px-7 py-3 '>Search</button>
                  </form>
                </div>
              </div>
            </div>
                      ...
                      <div className='relative'>
                      {
                        ...
                        {BannerImgDes.one ? <>
                              <div className='absolute bottom-[150%] left-[50%] bg-white px-5 py-2 rounded w-60 shadow'>
                                ...
                                <p>This is<a href="https://amirhamzadev.com"> Amir Hamza</a>.</p>
                              </div>
                            </> : ""
                        }
                      </div>
                      ...
                      <div className='absolute top-96 left-40'>
                        <div className='relative'>
                        {
                          ...
                          
                          {
                            ...
                            <div className='absolute bottom-[150%] left-[50%] bg-white px-5 py-2 rounded w-60 shadow'>
                            <p className='text-gray-600'><b>Hello</b></p>
                            <p>This is <a a href="https://amirhamzadev.com/"> Amir Hamza</a>.</p>
                          </div>
                            </> : <></>
                          }
