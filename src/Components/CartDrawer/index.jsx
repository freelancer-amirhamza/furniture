...
function CartDrawer() {
    ...
    return (
        <div>
            <button onClick={() => setDrawer(true)} className="fixed rounded bottom-10 right-4 bg-[#EAC575] p-5 text-2xl z-50" >
                <span>
            ...
            >
                <div className="px-3 flex flex-col h-full">
                    ...
                    <div className="border-t mb-3">
                        ...
                        <button className='bg-[#492705] text-white py-3  w-full block'>Checkout</button>
                    </div>
                </div>
            </Drawer>
        </div>
