        ...
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-9">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
                <h1 className="w-1/2 uppercase text-3xl text-[#FFBB05] font-bold"> Developer <span className=''>Amirhamza</span> </h1>
                <p className='text-md text-gray-300 md:mt-8 md:mb-20 my-4'>625 E Franklin Ave, Minneapolis, <br/>  MN 55404, USA</p>
                <p className='text-md text-gray-300'>&copy;{new Date().getFullYear()} <a className='underline font-bold' href="https://amirhamzadev.com">Amir Hamza</a>. All rights reserved.</p>
              </div>
              <div>
                <div>
